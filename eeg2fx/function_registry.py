...
FEATURE_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "coherence_band": {
        "type": "channel_pair",
        "description": "Coherence between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "plv": {
        "type": "channel_pair",
        "description": "Phase-locking value between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "alpha_asymmetry": {
        "type": "channel_pair",
        "description": "Alpha power asymmetry between two channels",
        "default_pairs": [["C3", "C4"]]
    },
    "mutual_information": {
        "type": "channel_pair",
        "description": "Mutual information between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "cross_correlation": {
        "type": "channel_pair",
        "description": "Cross correlation between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "phase_synchronization": {
        "type": "channel_pair",
        "description": "Phase synchronization between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "amplitude_correlation": {
        "type": "channel_pair",
        "description": "Amplitude correlation between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "granger_causality": {
        "type": "channel_pair",
        "description": "Granger causality between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "directed_transfer_function": {
        "type": "channel_pair",
        "description": "Directed transfer function between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "synchronization_likelihood": {
        "type": "channel_pair",
        "description": "Synchronization likelihood between two channels",
        "default_pairs": [["C3", "C4"], ["F3", "F4"], ["P3", "P4"]]
    },
    "zscore_stddev": {"type": "scalar", "description": "Z-score standard deviation (scalar value)"},
}

def get_preprocessing_funcs() -> Dict[str, Callable]:
    """
    Get the dictionary mapping preprocessing step names to their functions.

    Returns:
        Dict[str, Callable]: Mapping from step name to function.
    """
    return {
        "raw": load_recording,
        "filter": filter,
...
PREPROCESSING_FUNCS: Dict[str, Callable] = get_preprocessing_funcs()

def get_feature_funcs() -> Dict[str, Callable]:
    """
    Get the dictionary mapping feature names to their corresponding functions.

    Returns:
        Dict[str, Callable]: Mapping from feature name to function.
    """
    return {
...
FEATURE_FUNCS: Dict[str, Callable] = get_feature_funcs()

def get_utility_funcs() -> Dict[str, Callable]:
    """
    Get the dictionary mapping utility function names to their functions.

    Returns:
        Dict[str, Callable]: Mapping from utility name to function.
    """
    return {
        "split_channel": split_channel,
    }

UTILITY_FUNCS: Dict[str, Callable] = get_utility_funcs()

def get_epoch_by_event_funcs() -> Dict[str, Callable]:
    """
    Get the dictionary mapping event-based epoching function names to their functions.

    Returns:
        Dict[str, Callable]: Mapping from function name to function.
    """
    return {
        "epoch_by_event": lambda context: lambda raw, **params: epoch_by_event(raw, recording_id=context["recording_id"], **params),
    }

EPOCH_BY_EVENT_FUNCS: Dict[str, Callable] = get_epoch_by_event_funcs()