...
def run(df_feat: pd.DataFrame, df_meta: pd.DataFrame, output_dir: str, **kwargs) -> str:
    ...
    """
    print(f"[classification] Start classification experiment")
    print(f"[classification] Feature matrix shape: {df_feat.shape}")
    print(f"[classification] Metadata shape: {df_meta.shape}")
    ...
    print(f"[classification] Classification experiment completed, results saved to: {output_dir}")
    return summary
...
def preprocess_data(df_feat: pd.DataFrame, df_meta: pd.DataFrame, 
    ...
    print(f"[classification] Final data shape: X={X.shape}, y={y.shape}")
    print(f"[classification] Target classes: {le.classes_}")
    print(f"[classification] Class distribution: {pd.Series(y).value_counts().to_dict()}")
...
def plot_classification_results(results: dict, output_dir: str):
    ...
    print("[classification] Plotting classification results...")
...
def plot_feature_importance_analysis(results: dict, X_train: pd.DataFrame, output_dir: str):
    ...
    print("[classification] Plotting feature importance analysis...")
